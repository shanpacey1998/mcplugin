...
class AddPermissionConstraint implements ConstraintInterface, LoaderAwareInterface
{
    ...
    public function validate(mixed $value): ?string
    {
        ...
        if ($player->hasPermission($permission->getName())) {
            return sprintf('%s already has the permission %s', $player->getName(), $permission->getName());
        }
